...
// Create OLAP Table
var workflowTable = new moose_lib_1.OlapTable("FooWorkflow", {}, {
    version: "3.1",
    components: {
        schemas: {}
    },
...
}, JSON.parse("[{\"name\":\"id\",\"data_type\":\"String\",\"primary_key\":true,\"required\":true,\"unique\":false,\"default\":null,\"ttl\":null,\"annotations\":[]},{\"name\":\"success\",\"data_type\":\"Boolean\",\"primary_key\":false,\"required\":true,\"unique\":false,\"default\":null,\"ttl\":null,\"annotations\":[]},{\"name\":\"message\",\"data_type\":\"String\",\"primary_key\":false,\"required\":true,\"unique\":false,\"default\":null,\"ttl\":null,\"annotations\":[]}]"), {
    validate: function (data) {
        var result = (function () { var _io0 = function (input) { return "string" === typeof input.id && "boolean" === typeof input.success && "string" === typeof input.message; }; var _vo0 = function (input, _path, _exceptionable) {
    ...
    assert: (function () { var _io0 = function (input) { return "string" === typeof input.id && "boolean" === typeof input.success && "string" === typeof input.message; }; var _ao0 = function (input, _path, _exceptionable) {
        if (_exceptionable === void 0) { _exceptionable = true; }
        return ("string" === typeof input.id || __typia_transform__assertGuard._assertGuard(_exceptionable, {
            ...
            expected: "string",
            value: input.id
        }, _errorFactory)) && ("boolean" === typeof input.success || __typia_transform__assertGuard._assertGuard(_exceptionable, {
            method: "____moose____typia.createAssert",
            path: _path + ".success",
            expected: "boolean",
            value: input.success
    ...
    is: (function () { var _io0 = function (input) { return "string" === typeof input.id && "boolean" === typeof input.success && "string" === typeof input.message; }; return function (input) { return "object" === typeof input && null !== input && _io0(input); }; })()
});
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    foo = {
                        ...
                        optionalText: Math.random() < 0.5 ? faker_1.faker.lorem.text() : undefined,
                    };
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, fetch("http://localhost:4000/ingest/Foo", {
                            method: "POST",
                            headers: {
                ...
                case 3:
                    response = _a.sent();
                    if (!response.ok) {
                        console.log("Failed to ingest record ".concat(i, ": ").concat(response.status, " ").concat(response.statusText));
                ...
                case 4:
                    error_1 = _a.sent();
                    console.log("Error ingesting record ".concat(i, ": ").concat(error_1));
                    workflowTable.insert([
                ...
                case 5:
                    ...
                    workflowTable.insert([
                        { id: "1", success: true, message: "Ingested ".concat(i, " records") },
                    ]);
...
exports.workflow = new moose_lib_1.Workflow("generator", {
