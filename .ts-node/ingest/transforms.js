...
models_1.FooPipeline.stream.addTransform(models_1.BarPipeline.stream, function (foo) { return __awaiter(void 0, void 0, void 0, function () {
...
var printFooEvent = function (foo) {
    ...
    console.log("  Timestamp: ".concat(new Date(foo.timestamp))); // timestamp is already in milliseconds
